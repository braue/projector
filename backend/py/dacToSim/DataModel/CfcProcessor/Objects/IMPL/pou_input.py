inst='''<Single Type="{{c994f6e0-311a-4a1c-bc38-75fe34892406}}" Method="IArchivable">
...
label='''<Single Type="{72f2b13f-5349-4a8a-bbe6-2bccf3f42179}" Method="IArchivable">
                ...
                <Single Name="Id" Type="long">1892</Single>
              </Single>'''
...
class POU_INPUT_PIN:
  rootType = "{c994f6e0-311a-4a1c-bc38-75fe34892406}"
  ...
  def fromInputs(self, name: str) -> 'POU_INPUT_PIN':
    self.id = 0
    self.name = name
  ...
  def toXmlInst(self) -> Element:
    element = Element('Single', Type= POU_INPUT_PIN.rootType, Method="IArchivable")
