seed='''<Single Type="{{f8db32ff-bdd5-49e9-9014-6d9a6dea5d8c}}" Method="IArchivable">
...
def genNodeChild(visuName, index, uniqueId):
    """
    Generates a node child XML string based on the provided parameters.
